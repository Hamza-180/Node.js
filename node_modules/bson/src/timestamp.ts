...
export class Timestamp extends LongWithoutOverridesClass {
  ...
  constructor(
    low?: bigint | Long | { t: number | Int32; i: number | Int32 }
  ) {
    if (low == null) {
      super(0, 0, true);
      ...
      const t = typeof low.t === 'number' ? low.t : low.t._bsontype === 'Int32' ? low.t.toNumber() : 0;
      const i = typeof low.i === 'number' ? low.i : low.i._bsontype === 'Int32' ? low.i.toNumber() : 0;
      if (t < 0 || i < 0) {
        throw new BSONError('Timestamp constructed from { t, i } must provide positive values');
      }
      if (t > 0xffffffff) {
